...
export default function EditCoursePage({ params }: EditCoursePageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // TODO: API呼び出し
      console.log('Updating course:', params.id, formData)
  ...
  const handleDelete = async () => {
    ...
    try {
      // TODO: API呼び出し
      console.log('Deleting course:', params.id)
            ...
            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-700 rounded-b-lg">
              <div className="flex justify-between">
                <button
                  ...
                  disabled={isDeleting}
                  className="px-4 py-2 border border-red-300 rounded-lg text-sm font-medium text-red-700 hover:bg-red-50 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
